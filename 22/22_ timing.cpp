...
LTexture prompTextTexture, timeTextTexture;
...
int main(int argc, char* args[]){
    ...
    while(!quit){
        ...
        prompTextTexture.render((WIDTH - prompTextTexture.getWidth()) / 2, 0);
        
        timeTextTexture.loadFromRenderedText("Seconds since start time " + to_string((SDL_GetTicks() - startTime)/1000), {0, 0, 0, 255});
...
void loadMedia(){
    ...
    prompTextTexture.loadFromRenderedText("Press enter to Reset Start Time", color);
}
